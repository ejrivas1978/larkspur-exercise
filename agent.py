...
def build_tools() -> List[Dict[str, Any]]:                 # ✏️ Build 1, step 1.3
    ...
    return [
        ...
        },
        {
            ...
            "description": (
                "Find alternative Larkspur flights for a disrupted customer. Call this after "
                "lookup_booking and get_flight_status confirm the disruption, and after "
                "check_policy confirms a waiver applies. Pass the origin, destination, "
                "disrupted date, and any constraints from the booking (fare family, loyalty "
                "tier). Returns a ranked list of available alternatives with seats. Do not "
                "call this before you know the customer is eligible — check_policy first."
            ),
            "input_schema": {
                "type": "object",
